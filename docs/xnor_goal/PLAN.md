...
- [ ] Add tests for compatibility, geometry, adaptive clamps, heatmap scaling, and benchmark crop-source checks.
- [ ] Run 30-image Windows smoke benchmarks for the required route set.
- [ ] Promote the best candidates to larger validation if the smoke result is promising.
- [ ] Decide whether 320-native training is practical; run it if it is likely to change the conclusion.
