...
- [x] Train and benchmark a 320-native STE/XNOR scout to test whether resolution mismatch is the remaining blocker.
- [x] Write `docs/xnor_heatmap_final_decision.md` with the final yes/no result and blocker analysis.
