...
| Handoff docs | Pass | `README.md`, `docs/current_results.md`, `docs/research_framing.md`, `docs/binary_xnor_core.md`, and this audit describe the runnable path, current claims, commands, and caveats. | `docs/next_goal.md`, `docs/phase0_inventory.md`, and `docs/pro_final_review.md` remain as goal/evidence/history docs rather than active command truth. |
